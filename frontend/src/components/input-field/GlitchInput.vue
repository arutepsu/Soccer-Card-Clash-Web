  ...
  <div class="glitch-input-wrapper">
    <div class="input-container">
      ...
      <div class="input-data-stream">
        <div class="stream-bar" v-for="i in 10" :key="i" :style="`--i: ${i - 1};`" />
      </div>
...
const inputId = computed(() => props.id ?? 'holo-input');
...
.input-scanline {
  ...
  background: linear-gradient(
    to bottom,
    transparent 0%,
    rgba(158, 54, 187, 0.1) 48%,
    rgba(158, 54, 187, 0.3) 50%,
    rgba(158, 54, 187, 0.1) 52%,
    transparent 100%
  );
  opacity: 0;
}
...
.holo-input:focus ~ .input-border {
  opacity: 1;
  border-color: rgba(145, 57, 201, 0.5);
}
